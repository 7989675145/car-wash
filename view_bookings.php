...
<div class="container">
	<div class="row mt-3 justify-content-center">
		<div class="col-6">
			<div class="alert alert-success msg hidden" id='ale' role="alert">
			Booking Successful 
			</div>
		</div>
	</div>
  ...
  <div class="modal-dialog">
	...
	<div class="row mt-9 justify-content-center login-form">
		...
		<form id="booking">
				...
				<select name="car_type" class="form-control mt-2" id="car_type" data_id="car_val" required/><br>
				...
				?>
				</select><span id="car_type_err" class="text-danger"></span>
				</div>
				...
				<label>Date</label>
				<input type="text" class="form-control"  id="datepicker" placeholder="Date" name="date"/><span id="date_err" class="text-danger"></span>
				...
				<label>Car Number</label>
				<input type="text" class="form-control car" minlength="10" maxlength="10" name="reg" id="reg" placeholder="Car Number" required/><span id="car_num" class="text-danger"></span><span id="car_num1" class="text-danger"></span><span id="car_num2" class="text-danger"></span><span id="car_num3" class="text-danger"></span>
				</div>
...
{
	if($_SESSION['server']=='http://localhost/car_wash/index.php')
	{
?>
	<script>
...
table();	
	...
	{		 
		...
		{
			$("#car_num2").html("Please use Capital letters");
			return false;
		}
		else
		{
